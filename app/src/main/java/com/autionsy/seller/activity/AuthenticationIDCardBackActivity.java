...
public class AuthenticationIDCardBackActivity extends BaseActivity {
    @BindView(R.id.title_tv)
    TextView title_tv;

    @BindView(R.id.id_card_back_iv)
    ImageView id_card_back_iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_authentication_id_card_back);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CameraActivity.REQUEST_CODE && resultCode == CameraActivity.RESULT_CODE) {
            ...
            if (!TextUtils.isEmpty(path)) {
                id_card_back_iv.setImageBitmap(BitmapFactory.decodeFile(path));
    ...
    public void postUploadFile(){
        ...
        String url = Constant.HTTP_URL + Constant.UPLOAD_ID_CARD_BACK;
